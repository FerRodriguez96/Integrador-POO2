...
public class App {
    public static void main(String[] args) {
        ...
        // app.post("/picole/update/{txtDni}", controladorPicole::modificarPicole);
        ...
        // muestra la lista de picoles guardados
        app.get("/bombon", controladorBombon::listar);
        ...
        // app.post("/bombon/update/{txtDni}", controladorBombon::modificarPicole);
