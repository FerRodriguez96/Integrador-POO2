...
public class ControladorPicole {
    ...
    public void agregarPicole(Context ctx) throws SQLException {
        ...
        var sabor = ctx.formParamAsClass("txtSabor", String.class).get();
    ...
    public void editarPicole(Context ctx) throws SQLException {
        ...
        // quiere editar
        modelo.picole = this.interfazPicoles.obtener(ctx.pathParamAsClass("txtSabor", String.class).get());
    ...
    public void eliminarPicole(Context ctx) throws SQLException {
        ...
        // eliminar
        this.interfazPicoles.borrar(ctx.pathParamAsClass("txtSabor", String.class).get());
