...
public class ControladorBombon {
	...
	public void editarBombon(Context ctx) throws SQLException {
		...
		// se le pasa al proceso de persistencia el id del paquete de bombon que se quiere editar
	...
	public void eliminarBombon(Context ctx) throws SQLException {
		// se le pasa al proceso de persistencia el sabor del bombon que se quiere eliminar
