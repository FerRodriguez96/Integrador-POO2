...
public class ControladorRepartidor {
	...
	public void nuevoRepartidor(Context ctx) throws SQLException {
		// el programa musetra el formulario para ingresar los datos de un nuevo repartidor
	...
	public void editarRepartidor(Context ctx) throws SQLException {
		...
		// se le pasa al proceso de persistencia el dni del repartidor que se quiere editar
	...
	public void eliminarRepartidor(Context ctx) throws SQLException {
		// se le pasa al proceso de persistencia el dni del repartidor que se quiere eliminar
